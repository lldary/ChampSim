...
struct my_perceptron : champsim::modules::branch_predictor {
...
template <std::size_t HISTLEN, std::size_t BITS>
auto my_perceptron::internal_perceptron<HISTLEN, BITS>::predict(std::bitset<HISTLEN> history) -> typename counter_type::value_type
{
...
template <std::size_t HISTLEN, std::size_t BITS>
void my_perceptron::internal_perceptron<HISTLEN, BITS>::update(bool result, std::bitset<HISTLEN> history)
{
